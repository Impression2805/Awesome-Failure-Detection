...
- Unified Out-Of-Distribution Detection: A Model-Specific Perspective (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com/content/ICCV2023/papers/Noh_Simple_and_Effective_Out-of-Distribution_Detection_via_Cosine-based_Softmax_Loss_ICCV_2023_paper.pdf)
...
- Towards More Reliable Confidence Estimation (**TPAMI** 2023) [[paper]](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10172026)
...
- Confidence estimation via auxiliary models (**TPAMI** 2021) [[paper]](https://arxiv.org/pdf/2012.06508.pdf)
...
- WDiscOOD: Out-of-Distribution Detection via Whitened Linear Discriminant Analysis (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com/content/ICCV2023/papers/Chen_WDiscOOD_Out-of-Distribution_Detection_via_Whitened_Linear_Discriminant_Analysis_ICCV_2023_paper.pdf)
- DIFFGUARD: Semantic Mismatch-Guided Out-of-Distribution Detection Using Pre-Trained Diffusion Models (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com/content/ICCV2023/papers/Gao_DIFFGUARD_Semantic_Mismatch-Guided_Out-of-Distribution_Detection_Using_Pre-Trained_Diffusion_Models_ICCV_2023_paper.pdf) [[code]](https://github.com/cure-lab/DiffGuard)
- Understanding the Feature Norm for Out-of-Distribution Detection (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com/content/ICCV2023/papers/Park_Understanding_the_Feature_Norm_for_Out-of-Distribution_Detection_ICCV_2023_paper.pdf)
- Nearest Neighbor Guidance for Out-of-Distribution Detection (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com/content/ICCV2023/papers/Park_Nearest_Neighbor_Guidance_for_Out-of-Distribution_Detection_ICCV_2023_paper.pdf)
- Residual Pattern Learning for Pixel-Wise Out-of-Distribution Detection in Semantic Segmentation (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com/content/ICCV2023/papers/Liu_Residual_Pattern_Learning_for_Pixel-Wise_Out-of-Distribution_Detection_in_Semantic_Segmentation_ICCV_2023_paper.pdf) [[code]](https://github.com/yyliu01/RPL)
- Unified Out-Of-Distribution Detection: A Model-Specific Perspective (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com/content/ICCV2023/papers/Noh_Simple_and_Effective_Out-of-Distribution_Detection_via_Cosine-based_Softmax_Loss_ICCV_2023_paper.pdf)
- Revisit PCA-based technique for Out-of-Distribution Detection (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com/content/ICCV2023/papers/Guan_Revisit_PCA-based_Technique_for_Out-of-Distribution_Detection_ICCV_2023_paper.pdf) [[code]](https://github.com/SYSU-MIA-GROUP/pca-based-out-of-distribution-detection)
- Hierarchical Visual Categories Modeling: A Joint Representation Learning and Density Estimation Framework for Out-of-Distribution Detection (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com/content/ICCV2023/papers/Li_Hierarchical_Visual_Categories_Modeling_A_Joint_Representation_Learning_and_Density_ICCV_2023_paper.pdf)
- Out-of-Distribution Detection for Monocular Depth Estimation (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com/content/ICCV2023/papers/Hornauer_Out-of-Distribution_Detection_for_Monocular_Depth_Estimation_ICCV_2023_paper.pdf)
- Simple and Effective Out-of-Distribution Detection via Cosine-based Softmax Loss (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com//content/ICCV2023/papers/Noh_Simple_and_Effective_Out-of-Distribution_Detection_via_Cosine-based_Softmax_Loss_ICCV_2023_paper.pdf)
...
- Detecting Out-of-distribution Data through In-distribution Class Prior (**ICML** 2023) [[paper]](https://proceedings.mlr.press/v202/jiang23e/jiang23e.pdf) [[code]](https://github.com/tmlr-group/class_prior)
- Concept-based Explanations for Out-of-Distribution Detectors (**ICML** 2023) [[paper]](https://arxiv.org/pdf/2306.03715.pdf) [[code]](https://github.com/jihyechoi77/concepts-for-ood)
- Decoupling MaxLogit for Out-of-Distribution Detection (**CVPR** 2023) [[paper]](https://openaccess.thecvf.com/content/CVPR2023/papers/Zhang_Decoupling_MaxLogit_for_Out-of-Distribution_Detection_CVPR_2023_paper.pdf) [[code]](https://github.com/HAIV-Lab/DML)
...
- Uncertainty-Aware Optimal Transport for Semantically Coherent Out-of-Distribution Detection (**CVPR** 2023) [[paper]](https://proceedings.mlr.press/v202/choi23e/choi23e.pdf) [[code]](https://github.com/LuFan31/ET-OOD)
